const ProductCardSkeleton = () => {
  return (
    <div className="bg-light w-[288px] h-[320px] rounded-lg p-4 animate-pulse">
      <div className="w-full h-52 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 bg-[length:200%_100%] animate-[loading_1.5s_infinite_linear] rounded-md"></div>
